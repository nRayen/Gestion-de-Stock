...
public class App extends JFrame {
    ...
    private void addUser() { // Ajout Utilisateur
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/testProjet", "root", "");
    ...
    private void removeUser() { // Suppression Utilisateur
        try {
            ...
            // Affichage d'un message de succès
            JOptionPane.showMessageDialog(this, "Utilisateur avec l'id " + id + " à été supprimé avec succès!");
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    private void editUser() { // Modification Utilisateur
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erreur lors de la modification de l'utilisateur: " + ex.getMessage());
        }
    }
